...
Maksimizirati želimo desno stran \ref{taylor}. To storimo tako, da gradient $L$ enačimo z nič:
\[
...
\end{align}
Zadnji vrstici v \ref{newtoneq} rečemo tudi \textit{Newtonova enačba}.
