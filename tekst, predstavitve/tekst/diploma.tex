...
%    \frac{\partial}{\partial\beta_{j}} \sum_{i = 1}^{n}\left(y_{i}\log\Phi(x_{i}^\top\beta) + (n_{i} - y_{i})\log(1 - \Phi(x_{i}^\top\beta)) \right) = \\
%    &= \sum_{i = 1}^{n}\left(\frac{\phi(x_{i}^\top\beta)}{\Phi(x_{i^\top\beta})}x_{ij} - (n_{i}-y_{i})\frac{\phi(x_{i}^\top\beta)}{1-\Phi(x_{i^\top\beta})} x_{ij}  \right) = \\
%    &= \sum_{i = 1}^{n}\phi(x_{i}^\top\beta)x_{ij}\left(\frac{y_{i}}{\Phi(x_{i}^\top\beta)} - \frac{n_{i}-y_{i}}{1-\Phi(x_{i}^\top\beta)}\right) = \\
%    &= \sum_{i = 1}^{n}\phi(x_{i}^\top\beta)x_{ij}\left(\frac{y_{i} - n_{i}\Phi(x_{i}^\top\beta)}{\Phi(x_{i}^\top\beta)(1-\Phi(x_{i}^\top\beta))}\right)
%\end{align*}
...
%    \frac{\partial}{\partial\beta_{k}}\left(\frac{y_{i} - n_{i}\Phi(x_{i}^\top\beta)}{\Phi(x_{i}^\top\beta)(1-\Phi(x_{i}^\top\beta))}\right) &= 
%    \frac{-n_{i}\phi(x_{i}^\top\beta)x_{ik}\Phi(x_{i}^\top\beta)(1-\Phi(x_{i}^\top\beta)) - (y_{i}-n_{i})\nicefrac{\partial}{\partial\beta_{k}(\Phi(x_{i}^\top\beta)(1-\Phi(x_{i}^\top\beta)))}}{(\Phi(x_{i}^\top\beta)(1-\Phi(x_{i}^\top\beta)))^2}
%\end{align}
...
%\begin{align*}
%    &\frac{-n_{i}\phi(x_{i}^\top\beta)\Phi(x_{i}^\top\beta)(1-\Phi(x_{i}^\top\beta))x_{ik} - (y_{i} - n_{i}\Phi(x_{i}^\top\beta))\phi(x_{i}^\top\beta)x_{ik}(1-2\Phi(x_{i}^\top\beta))}{(\Phi(x_{i}^\top\beta)(1-\Phi(x_{i}^\top\beta)))^2} \\
%    &\phi(x_{i}^\top\beta)x_{ik}\frac{2y_{i}\Phi(x_{i}^\top\beta) - n_{i}\Phi(x_{i}^\top\beta)^2 - y_{i}}{(\Phi(x_{i}^\top\beta)(1-\Phi(x_{i}^\top\beta)))^2}
%\end{align*}
